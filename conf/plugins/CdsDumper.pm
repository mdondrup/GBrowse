...
Bio::Graphics::Browser2::Plugin::CdsDumper - A plugin for dumping translated protein sequences in various formats
...
Bio::Graphics::Browser to dump spliced coding sequences of genes from an
...
package Bio::Graphics::Browser2::Plugin::CdsDumper;
# $Id: ProteinDumper.pm,v 1.5 2006-08-30 02:37:07 lstein Exp $
